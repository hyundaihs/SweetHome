    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        switch (mOrientation) {
            case BOTH_SET:
                ...
                int r = isLastColumn(parent, itemPosition, spanCount, childCount) ? 0 : mDividerHeight;
                int b = isLastRaw(parent, itemPosition, spanCount, childCount) ? 0 : mDividerHeight;
//                if (isLastRaw(parent, itemPosition, spanCount, childCount)) {
//                    Log.d("tag", "是最后一行" + itemPosition);
//                    // 如果是最后一行，则不需要绘制底部
//                    b = 0;
//                }
//                if (isLastColumn(parent, itemPosition, spanCount, childCount)) {
//                    Log.d("tag", "是最后一列" + itemPosition);
//                    // 如果是最后一列，则不需要绘制右边
//                    r = 0;
//                }
                Log.d("tag1", "r = " + r + " b = " + b);
