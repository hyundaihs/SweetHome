...
import com.cyf.heartservice.entity.Notify
import com.cyf.heartservice.entity.NotifyListRes
import com.cyf.heartservice.entity.TZGGLISTS
...
class SecretaryActivity : MyBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentBaseView(R.layout.activity_secretary)
        setTitle("小秘书")
        initViews()
    }
    ...
    private fun initViews() {
        ...
        notifyAdapter.myOnItemClickListener = object : MyBaseAdapter.MyOnItemClickListener {
            override fun onItemClick(parent: MyBaseAdapter, view: View, position: Int) {
                val intent = Intent(this@SecretaryActivity, NotifyDetailsActivity::class.java)
