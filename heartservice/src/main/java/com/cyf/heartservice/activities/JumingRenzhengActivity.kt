...
import com.cyf.heartservice.HeartService.Companion.CHOOSE_COMMUNITY_RESULT
import com.cyf.heartservice.R
import com.cyf.heartservice.entity.*
import com.cyf.heartservice.util.PickerUtil
...
class JumingRenzhengActivity : MyBaseActivity() {
    ...
    private fun check(): Boolean {
        when {
            ...
            renzhengPhone.text.isEmpty() ->{
                renzhengPhone.error = "手机号码不能为空"
                return false
            }
    ...
    private fun submit() {
        ...
        val map = mapOf(
            ...
            Pair("phone", renzhengPhone.text.toString()),
